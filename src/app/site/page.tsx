  ...
  return (
    <main className="">
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#161616_1px,transparent_1px),linear-gradient(to_bottom,#161616_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_160%)] -z-10" />
        ...
        <div className="flex items-center justify-center relative md:mt-[-80px]">
          <Image 
            ...
            <Card key={card.title} className={clsx("w-[300px] flex flex-col justify-between", {"border-2 border-primary":card.title==="Unlimited Saas"})}>
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                ...
                <Link 
                  ...
                  className={clsx('w-full text-center rounded-md bg-primary p-2',{'!bg-muted-foreground':card.title!=="Unlimited Saas"})}
                >
                  Join Now!
                </Link>
              </CardFooter>
